...
class TaskController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Checklists di-load saat buka detail, bukan di list
    ...
    public function trashBulkAction(Request $request)
    {
        ...
        if ($action == 'restore_all') {
            ...
            foreach ($tasks as $task) {
                ...
                if (isset($task->mockups)) {
                    foreach ($task->mockups as $mockup) {
                        if (isset($mockup->file_path)) {
                ...
                // Fix: Handle case where $task might be stdClass
                if ($task instanceof \App\Models\Task) {
                    $task->forceDelete();
                } else {
                    Task::withTrashed()->where('id', $task->id)->forceDelete();
                }
            }
