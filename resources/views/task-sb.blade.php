                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            <a href="{{ route('task', ['sort' => 'nama_pelanggan', 'order' => $newOrder]) }}">
                                Klien
                                @if($currentSort == 'nama_pelanggan') <i
                                    class="bi {{ $currentOrder == 'asc' ? 'bi-caret-up-fill' : 'bi-caret-down-fill' }}"></i>
                                @endif
                            </a>
                        </th>
            ...
            <form id="taskForm">
                ...
                <div class="mb-2 position-relative pj-wrapper">
                    ...
                    <div class="position-relative input-with-toggle">
                        <input type="text" id="penanggungJawabInput" class="form-control pj-input"
