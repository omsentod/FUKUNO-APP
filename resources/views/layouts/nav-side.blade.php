...
<body>
                                ...
                                <div class="notification-content">
                                    <p>
                                        @if(isset($notification->data['creator_name']))
                                            ...
                                            @else
                                                telah membuat task:
                                                <strong>{{ Str::limit($notification->data['task_title'], 25) }}</strong>
                                            @endif
                                        @else
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div
                class="sidebar-item {{ (request()->routeIs('task') || (request()->routeIs('task.show') && !request()->has('from'))) ? 'active' : '' }}">
            ...
            @if(Auth::user()->role == 'admin')
                ...
                <div
                    class="sidebar-item {{ (request()->routeIs('archive') || (request()->routeIs('task.show') && request('from') == 'archive')) ? 'active' : '' }}">
                ...
                <div
                    class="sidebar-item {{ (request()->routeIs('trash') || (request()->routeIs('task.show') && request('from') == 'trash')) ? 'active' : '' }}">
